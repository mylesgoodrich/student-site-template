...
import JourneyMapPremium from "../components/JourneyMapPremium";
...
type JourneyEvent = {
  ...
  dateLabel: string;
  title: string;
  short: string; // short label shown on timeline chips / quick references
  summary: string;
  detail: string;
  tags: string[];
  relatedSlugs?: string[];
      ...
      <header className="lsu-card relative overflow-hidden">
        ...
        <div className="relative space-y-3">
          ...
          <p className="max-w-3xl text-base leading-7 text-muted">
            Click through the route. Each checkpoint is a moment that shaped how
            I work: structure, evidence, discipline, and execution under
            pressure.
          </p>
      ...
      <section className="grid gap-6 lg:grid-cols-12">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        {e.tags.map((t) => (
                          <TagPill key={t} label={t} variant="compact" />
                        ))}
                      </div>
                    </button>
                  );
        ...
        <div className="lg:col-span-5">
          <div className="lsu-card relative overflow-hidden">
            <div className="absolute -right-24 -top-24 h-64 w-64 rounded-full bg-brand-purple/[0.06] blur-2xl" />
            <div className="absolute -left-24 -bottom-24 h-64 w-64 rounded-full bg-brand-gold/[0.08] blur-2xl" />
                    ...
                    {active.relatedSlugs.map((slug) => {
                      ...
                      return (
                        <Link
                          ...
                          className="rounded-xl border border-border bg-surface px-4 py-3 transition hover:bg-surface-2"
                        >
                ...
                >
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {p.tags.slice(0, 3).map((t) => (
                      <TagPill key={t} label={t} variant="small" />
                    ))}
                  </div>
                </Link>
              ))}
